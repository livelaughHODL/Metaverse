...
const ether = (n) => {
  ...
  let usdc, owner1
  owner1 = await web3.eth.getAccounts();
...
module.exports = async function(callback) {
    ...
    try {
        ...
        // Assign owner1 to the first account generated by ganache
        const owner1 = accounts[0]

        // UNLOCKED_ACCOUNT transfers USDC to owner1
        await usdc.transfer(owner1, AMOUNT, { from: UNLOCKED_ACCOUNT })
    }
